...
This guide covers scanning and photographing artwork. It does not cover what camera or printer to purchase, color management, print production, or selling prints.

## What You Need
The exact requirements depend on whether you choose to scan or photograph the artwork. For help selecting a method, see [Choose a Digitization Method](#choose-a-digitization-method). A scanner is an excellent choice for smaller artworks on paper, such as watercolor paintings. Larger artwork (larger than A3) or painted canvases generally needs to be photographed instead. With this in mind, most artists will need the following:
...
| Scanner                              | Camera                          |
| ------------------------------------ | ------------------------------- |
| Best for small artwork               | Best for large artwork          |
| Excellent for flat surfaces          | Excellent for textured surfaces |
| Consistent lighting                  | Requires careful lighting setup |
| Simple workflow                      | More flexible workflow          |
...
Follow these steps to create a high-quality digital image of your artwork. Good lighting is essential for creating high-quality images with accurate colors. Here is a good, in-depth, guide on [How to photograph your artwork using studio lighting](https://www.aapgh.org/blog/photography-tips). 
