...
- troubleshoot common access and account issues
...
I planned and wrote this documentation sample as a portfolio project.

My work included:

- defining a realistic product scenario
- identifying target audiences
- structuring the documentation set
- writing clear and task-oriented content
- considering both user needs and support needs
- connecting documentation to product, support and knowledge management workflows
...
- create structured product documentation
- write for both technical and non-technical users
- explain product functionality clearly
- support customer success and product support workflows
- organize reusable knowledge
- write task-based instructions
- think from both a user and support perspective

## Status

This is a fictional portfolio project created to demonstrate technical communication skills across product documentation, support documentation and knowledge management.
